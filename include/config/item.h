...
#define I_TM_HM_MOVE_DESCRIPTION    GEN_5   // In Gen5+, TMs & HMs always use the move description. Setting this to GEN_5 or higher may reduce effort needed to add new TMs but adjusting the formatting of TM & HM descriptions will no longer be possible.
