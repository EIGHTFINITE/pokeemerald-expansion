...
#define OW_ALTERED_TIME_RATIO           GEN_LATEST   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. Other values are 1:1, and meant for debugging purposes. This has no effect if OW_USE_FAKE_RTC is FALSE.
