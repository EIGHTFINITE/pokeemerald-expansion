...
enum __attribute__((packed)) Move
{
    ...
    // Hidden Power Moves
    MOVE_HIDDEN_POWER_FIGHTING = MOVES_COUNT_GEN9,
    MOVE_HIDDEN_POWER_FLYING = 849,
    MOVE_HIDDEN_POWER_POISON = 850,
    MOVE_HIDDEN_POWER_GROUND = 851,
    MOVE_HIDDEN_POWER_ROCK = 852,
    MOVE_HIDDEN_POWER_BUG = 853,
    MOVE_HIDDEN_POWER_GHOST = 854,
    MOVE_HIDDEN_POWER_STEEL = 855,
    MOVE_HIDDEN_POWER_FIRE = 856,
    MOVE_HIDDEN_POWER_WATER = 857,
    MOVE_HIDDEN_POWER_GRASS = 858,
    MOVE_HIDDEN_POWER_ELECTRIC = 859,
