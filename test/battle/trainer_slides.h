[DIFFICULTY_NORMAL] =
{
    [TRAINER_LEAF_TEST] =
    {
        ...
        [TRAINER_SLIDE_DEFENDER_LOSES_FIRST_MON] = COMPOUND_STRING("Trainer A: This message plays after the defender loses one mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_DEFENDER_TAKES_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer A: Opponent attacked defender with ineffective move.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_SELF_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer A: This message plays before the battler activates the Mega Evolution gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_Z_MOVE] = COMPOUND_STRING("Trainer A: This message plays before the battler activates the Z-Move gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_DYNAMAX] = COMPOUND_STRING("Trainer A: This message plays before the battler activates the Dynamax gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_TERA] = COMPOUND_STRING("Trainer A: This message plays before the battler activates the Tera gimmick.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_ATTACKER_FAINTS_FIRST_MON] = COMPOUND_STRING("Trainer A: This message plays after the attacker KOs one opponent mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer A: Attacker attacked opponent with ineffective move.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_RED_TEST] =
    {
        ...
        [TRAINER_SLIDE_DEFENDER_LOSES_FIRST_MON] = COMPOUND_STRING("Trainer B: This message plays after the defender loses one mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_DEFENDER_TAKES_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer B: Opponent attacked defender with ineffective move.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_SELF_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer B: This message plays before the battler activates the Mega Evolution gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_Z_MOVE] = COMPOUND_STRING("Trainer B: This message plays before the battler activates the Z-Move gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_DYNAMAX] = COMPOUND_STRING("Trainer B: This message plays before the battler activates the Dynamax gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_TERA] = COMPOUND_STRING("Trainer B: This message plays before the battler activates the Tera gimmick.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_ATTACKER_FAINTS_FIRST_MON] = COMPOUND_STRING("Trainer B: This message plays after the attacker KOs one opponent mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer B: Attacker attacked opponent with ineffective move.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_PARTNER(PARTNER_STEVEN_TEST)] =
    {
        ...
        [TRAINER_SLIDE_DEFENDER_LOSES_FIRST_MON] = COMPOUND_STRING("Trainer Partner: This message plays after the defender loses one mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_DEFENDER_TAKES_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer Partner: Opponent attacked defender with ineffective move.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_SELF_MEGA_EVOLUTION] = COMPOUND_STRING("Trainer Partner: This message plays before the battler activates the Mega Evolution gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_Z_MOVE] = COMPOUND_STRING("Trainer Partner: This message plays before the battler activates the Z-Move gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_DYNAMAX] = COMPOUND_STRING("Trainer Partner: This message plays before the battler activates the Dynamax gimmick.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_SELF_TERA] = COMPOUND_STRING("Trainer Partner: This message plays before the battler activates the Tera gimmick.{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_SLIDE_ATTACKER_FAINTS_FIRST_MON] = COMPOUND_STRING("Trainer Partner: This message plays after the attacker KOs one opponent mon.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_INEFFECTIVE] = COMPOUND_STRING("Trainer Partner: Attacker attacked opponent with ineffective move.{PAUSE_UNTIL_PRESS}"),
